...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin',
 'BINLIBDEST': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
              '/usr/bin/gcc -shared '
              '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
              '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
              '-Wl,--enable-new-dtags',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'BYTESTR_DEPS': '\\',
 'CC': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
       '/usr/bin/gcc',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall -O2 '
           '-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'CONFIGURE_LDFLAGS': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                      '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                      '-Wl,--enable-new-dtags',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host' "
                "'--sysconfdir=/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/etc' "
                "'--localstatedir=/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/var' "
                ...
                "'PKG_CONFIG=/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/pkg-config' "
                "'PKG_CONFIG_LIBDIR=/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/pkgconfig:/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/share/pkgconfig' "
                "'CC=/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache "
                "/usr/bin/gcc' 'CFLAGS=-O2 "
                "-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include' "
                "'LDFLAGS=-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib "
                '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                "-Wl,--enable-new-dtags' "
                "'CPPFLAGS=-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include' "
                "'CPP=/usr/bin/cpp'",
 'CONFINCLUDEDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'CONFINCLUDEPY': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'CPPFLAGS': '-I. -I./Include '
             '-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'CXX': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
        '/usr/bin/g++',
 ...
 'DESTDIRS': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host '
             '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
             '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11 '
             '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11/lib-dynload',
 'DESTLIB': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include '
                   '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include '
                   '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include/python3.11 '
                   '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include/python3.11',
 'INCLUDEDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'INCLUDEPY': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include/python3.11',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
                '/usr/bin/g++ -shared',
 'LDFLAGS': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
            '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
            '-Wl,--enable-new-dtags',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
             '/usr/bin/gcc -shared '
             '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
             '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
             '-Wl,--enable-new-dtags',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11',
 'LIBDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/pkgconfig',
 'LIBPL': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBS': '-ldl',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
           '/usr/bin/gcc',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/bin/ccache '
           '/usr/bin/gcc',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'MODULE_BINASCII_LDFLAGS': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include',
 'MODULE_ZLIB_LDFLAGS': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                        '-lz',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall -O2 '
                   ...
                   '-I/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/include '
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                    '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                    '-Wl,--enable-new-dtags',
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
               '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
               '-Wl,--enable-new-dtags',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                     '-Wl,-rpath,/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib '
                     '-Wl,--enable-new-dtags',
 ...
 'SCRIPTDIR': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-ldl',
 'SHLIB_SUFFIX': '.so',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host',
 'WASM_STDLIB': './home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 0,
 ...
 'datarootdir': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host/share',
 'exec_prefix': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host',
 'prefix': '/home/yulu/Desktop/Projects/keystone/build-generic64/buildroot.build/per-package/host-qemu/host',
 'srcdir': '.'}
